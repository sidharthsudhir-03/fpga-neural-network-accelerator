module fpga_nn_top(input logic CLOCK_50, input logic [3:0] KEY, // KEY[3] is async active-low reset
             ...
             inout wire [15:0] DRAM_DQ, output logic DRAM_UDQM, output logic DRAM_LDQM,
